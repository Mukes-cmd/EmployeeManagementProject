...
const Failed = ({data}) => {
  return (
     <div className=' flex-shrink-0 h-full w-[300px] p-5 bg-emerald-950 rounded-xl'>
                ...
                <p className='text-sm text-white mt-2'>{data.description}</p>
                 <div className='mt-4'>
                    <button className=' w-full bg-green-500 px-1 py-2 text-sm rounded-sm'>Failed Task</button>
